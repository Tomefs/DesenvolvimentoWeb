...
function loadContent(key) {
  ...
  let title = selectedData.name;
  let description = selectedData.description;

  let titleElement = document.createElement("h1");
  titleElement.textContent = title;

  let descriptionElement = document.createElement("h3");
  descriptionElement.textContent = Array.isArray(description)?description.join(" "):description;
